...
TEMP R2;
MOV R0.x, c[0];
MAD R0.y, R0.x, c[3].x, fragment.texcoord[0];
MOV R0.x, fragment.texcoord[0];
MAX R0.w, fragment.texcoord[1].z, c[4].x;
...
TEMP R1;
MOV R0.x, c[0];
MAD R0.y, R0.x, c[2].x, fragment.texcoord[0];
MOV R0.x, fragment.texcoord[0];
...
MOV R0.x, c[0];
MAD R2.y, R0.x, c[2].x, fragment.texcoord[0];
...
dcl_2d s1
dcl_2d s2
def c3, 0.57735026, 8.00000000, 0, 0
dcl t0.xy
dcl t1.xy
texld r2, t1, s2
mov r0.x, c2
mad r1.y, c0.x, r0.x, t0
mov r1.x, t0
...
MIN R1.xyz, R1, R2;
MOV R0.x, fragment.texcoord[0];
MAD R0.y, R0, c[2].x, fragment.texcoord[0];
MAX R1.xyz, R1, R3;
MOV result.color.w, c[1];
TEX R0.xyz, R0, texture[0], 2D;
MUL R0.xyz, R0, c[1];
...
dcl_2d s2
dcl_2d s3
def c3, 0.57735026, 8.00000000, 2.00000000, 0
dcl t0.xy
dcl t1.xy
dcl t3
texld r1, t1, s2
