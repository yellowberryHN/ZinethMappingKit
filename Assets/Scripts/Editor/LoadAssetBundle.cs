...
public class LoadAssetBundle : EditorWindow
{
	...
	/// </summary>
	private static LoadAssetBundle _wnd;
	...
	/// </summary>
	[MenuItem("Assets/Bundles/Load Temp AssetBundle", true, 111)]
	...
	/// </summary>
	[MenuItem("Assets/Bundles/Load Temp AssetBundle", false, 111)]
	...
	/// </summary>
	[MenuItem("Assets/Bundles/Unload Temp AssetBundles", false, 112)]
	...
	{
		_wnd = GetWindowWithRect<LoadAssetBundle>(new Rect(0,0,1,1));
	}
	/// <summary>
